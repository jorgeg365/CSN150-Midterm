...
3. Installing the agent using the wazuh installation guide you have to make sure to fill in your ip address with your server address from Digital Ocean and the kast command was not working for me. ![agentnetstart](wazuhagentIP.png)
)
4. Problem 4 ... ETC
