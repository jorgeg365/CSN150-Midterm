...
4. Method that worked was in taskbar search bar type services open look for wazuh then right click, click properties and click start then refresh your wazuh dashboard page. ![wazuhstart]()
