...
1. Following the wazuh websites [installation](https://documentation.wazuh.com/current/installation-guide/wazuh-server/installation-assistant.html) [wazuh](![Uploading github1.png…]()
)
2. Problem 2
3. Problem 3
4. Problem 4 ... ETC
